...
export class TranscriptMiner {
  ...
  async processMessages(messages: string[], sessionFile: string): Promise<number> {
    ...
    const systemPrompt = [
      "You are a memory extraction assistant. Extract factual statements about the USER's",
      "preferences, habits, corrections, project context, and technical decisions from the",
      "conversation messages provided. Focus on:",
      ...
      "Maximum 20 facts. If no clear facts can be extracted, return an empty array [].",
      "",
